...
func (m *NetFlowRecord) DataType() string {
	return "flowRecord"
}

// SetDataType sets the data type of this subtype
func (m *NetFlowRecord) SetDataType(val string) {
...
func (m *NetFlowRecord) UnmarshalJSON(raw []byte) error {
	var data struct {
...
func (m NetFlowRecord) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
